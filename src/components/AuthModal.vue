...
<template>
    <div>
        <a-button type="primary" @click="showModal" class="nav-button">{{ title }}</a-button>
        <a-modal v-model:open="open" :title="title" @ok="handleOk">
            ...
            <div :class="{ invisible: loading }">
                <a-input v-if="!isLogin" v-model:value="userCredentials.username" placeholder="username" class="input-text" />
                <a-input v-model:value="userCredentials.email" placeholder="email" class="input-text" />
                <a-input v-model:value="userCredentials.password" placeholder="password" type="password" class="input-text" />
            </div>
